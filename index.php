...
ini_set('display_errors', 1);
  $MAIN_ENDPOINT = "http://127.0.0.1:1605/";
  $TEST_ENDPOINT = "http://127.0.0.1:29706/";
  define("BASE_URL", "/explorer/");
  define("USE_MOD_REWRITE", true);
  // enable mod rewrite mode to have nice URLs like /block/<hash> instead of index.php?block=<hash>
  $FOOTER = '<a href="https://github.com/LightBitProject/Explorer">Rescue LITB Explorer</a> for LightBIT Core';
  $TITLE = "LITB Explorer";
###### END CONFIG SECTION
  $HTMLTITLE = $TITLE;
